    ...
    <main class="main-content-section">
            ...
            <form id="searchForm" method="GET" action="{{ route('superadmin.indikator_mutu.create') }}" class=" d-flex justify-content-between
                ...
                <div class="d-flex align-items-center gap-2">
                    ...
                    <select name="limit" class="form-select"
                        style="width: auto; border-radius: 12px; border: 1px solid var(--primary-color);"
        ...
        <div class="indicator-table-container">
            ...
            <div class="crud-table-wrapper">
                <table class="crud-table">
                    ...
                    <tbody>
                        ...
                        @else
                            {{-- Loop langsung ke $indikators, tidak perlu loop nested --}}
                            @foreach ($indikators as $index => $indikator)
                                <tr>
                                    {{-- Rumus Nomor Urut Pagination: (Halaman Saat Ini - 1) * Limit + Index + 1 --}}
            ...
            <div class="d-flex justify-content-end mt-3">
                {{ $indikators->onEachSide(1)->links('pagination::bootstrap-5') }}
            </div>
        </div>
    </main>
