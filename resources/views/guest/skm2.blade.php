...
@section('content')
    <main id="survey-section" class="survey-wrapper">
        <div class="survey-container">
            <h2 class="survey-title">Pelayanan Publik</h2>
        ...
        <div class="form-navigation">
            <button class="nav-button prev-button" onclick="window.location.href='/guest/data_responden'">
                <span>Sebelumnya</span>
            </button>
            <button class="nav-button next-button" onclick="window.location.href='guest.skm3'">
