                    ...
                    <div class="form-grid">
                        ...
                        <div class="form-column">
                            <div class="form-group">
                                <label for="no_rm" class="form-label">Nomor Responden (No. RM)<span
                        ...
                        <div class="form-column">
                            ...
                            <div class="form-group">
                                <label for="pekerjaan" class="form-label">Pekerjaan Utama<span
                                        class="required-asterisk">*</span></label>
                                <div class="select-wrapper">
                                    ...
                                    @foreach ($pilihanJawaban[$item->id_pertanyaan] as $pilihan)
                                        <div class="option-item">
                                            <input type="radio" id="pilihan_{{ $pilihan->id_pilihan }}"
                                                name="jawaban[{{ $item->id_pertanyaan }}]" value="{{ $pilihan->id_pilihan }}" required>
